 ...
 * Photoshop CS5+ — Link View 1 copy và CHAIN copy, position CHAIN copy
 * 
 * Workflow:
 * - Tìm View 1 copy và CHAIN copy
...
(function () {
    ...
    try {
        ...
        // Tìm layer View 1 copy
        var layer1Copy = findLayerByName(doc, "View 1 copy");
        if (!layer1Copy) {
            throw new Error("Không tìm thấy layer 'View 1 copy'.");
        }
        ...
        // Link View 1 copy với CHAIN copy
        ...
        if (chainRulesLayer) {
            // Position CHAIN copy: canh giữa X và sát dưới CHAINRULES
            // Vì đã link, View 1 copy sẽ di chuyển theo
