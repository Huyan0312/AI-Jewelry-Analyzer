...
// ===============================================
// WORKFLOW:
// 1. Chọn tất cả layer cần thiết (Layer 1-7)
...
var mergeWithNewLayers = false; // true = merge với New 1, New 3, New 6 | false = CHỈ merge Layer 1-7
...
if (app.documents.length === 0) {
    ...
    try {
        ...
        // 1. Chọn CHỈ các layer cần thiết (Layer 1-7)
        var layersToMerge = ["Layer 1", "Layer 2", "Layer 3", "Layer 4", "Layer 5", "Layer 6", "Layer 7"];
        ...
        message += "📦 Đã chọn: " + mergedLayerCount + " layer (Layer 1-7";
        if (mergeWithNewLayers) {
            message += " + New layers";
        }
        message += ")\n";
