...
def main():
    print("=== REGENERATING 21 VIEWS WITH CURRENT CODE BASE ===")
    ...
    for img_name, json_name in samples:
        ...
        for view_item in views_payload:
            ...
            print(f"  [{view_name}] processed -> quality_valid={res.get('validation', {}).get('quality_valid')} | clean_object={res.get('clean_object')}")
